  ...
  head: () => ({
    meta: [
      ...
      { title: "TaniAI Nexus — Platform AI Pertanian Indonesia" },
      {
        name: "description",
        content:
          "Platform AI pertanian terlengkap: diagnosis tanaman dari foto, asisten AI 24/7, cuaca real-time, komunitas petani, dan edukasi. Gratis untuk petani Indonesia!",
      },
      {
        name: "keywords",
        content:
          "pertanian, AI, diagnosa tanaman, penyakit tanaman, petani Indonesia, asisten pertanian, cuaca pertanian, komunitas petani",
      },
    ...
    links: [{ rel: "canonical", href: "https://tani-ai-nexus.vercel.app" }],
  }),
